...
dependencies {
    ...
    implementation("no.nav.common:audit-log:4.2026.06.17_05.49-50af4f38147e")
    implementation("io.opentelemetry.instrumentation:opentelemetry-logback-mdc-1.0:2.29.0-alpha")
